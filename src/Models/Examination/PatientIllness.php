...
use Gii\ModuleExamination\Resources\Examination\PatientIllness\{
    ViewPatientIllness, ShowPatientIllness
};
...
class PatientIllness extends Examination {
    ...
    protected $list = [
        'id','reference_type','reference_id','name','patient_id','props'
    ];

    protected $show = [
        'examination_summary_id','patient_summary_id', 
        'disease_type', 'disease_id', 'disease_name', 
